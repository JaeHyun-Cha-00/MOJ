...
writer_prompt = """For each introduction, you need to:
...
2. If it contains a joke:
   ...
   - Give it funniness ratings from the perspective of the comedy writer, using this scale:
   1: Crickets
...
# Save to CSV
output_path = "../../converted_dataset/buzzbench/default/buzzbench_converted_writer.csv"
